...
| Analyze / Score Listings | `digitized_user`, candidate listings, optional scoring settings | Candidate listings snapshot | Scored listings table | Stored scored candidates + per-batch result snapshot | Listings table + checkboxes + weights |
