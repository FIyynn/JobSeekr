...
from services.web.markdown import output_markdown, _remove_markdown_links
            ...
            if form is not None:
                ...
                try:
                    if submit_button is not None:
                        ...
                        driver.execute_script(
                            "if (arguments[0] && typeof arguments[0].requestSubmit === 'function') { arguments[0].requestSubmit(); return true; } return false;",
                            form,
                        )
                except Exception:
                    try:
