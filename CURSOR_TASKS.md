...
- Lines 116–121: added `ALTER TABLE outreach_attempts ADD COLUMN warm_lead_score` migration guard (try/except)

**engine/warm_lead.py**
- Lines 69–71: `enrich_contact_warmth` now assigns `warm_lead_score` as an explicit `float` clamped to 0–100
