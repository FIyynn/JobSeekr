...
- Lines 116–121: migration guard `ALTER TABLE outreach_attempts ADD COLUMN warm_lead_score REAL DEFAULT 0.0` in try/except

**engine/warm_lead.py**
- Lines 69–70: `enrich_contact_warmth` sets `warm_lead_score` as `float` clamped 0–100
