...
- Lines 116–121: added migration guard (`ALTER TABLE ... ADD COLUMN` in try/except)

**engine/warm_lead.py**
- Lines 69–70: `enrich_contact_warmth` now sets `warm_lead_score` as explicit float clamped 0–100
